...
import jp.osaka.cherry.stamp.databinding.ActivityYellowBinding;
 ...
 * メインアクティビティ
 */
public class YellowActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // レイアウト設定
        ActivityYellowBinding binding = DataBindingUtil.setContentView(this, R.layout.activity_yellow);
        ...
        if (bar != null) {
            bar.setTitle(R.string.yellow_stamp);
        }
        ...
        // 登録
        mState.setId(R.id.yellow);
        mState.registerCallacks(this);

        if(!mRedos.isEmpty()) {
            mPref.edit().putInt(EXTRA_CONTENT, R.id.yellow).apply();
        }
    }
    ...
    private void updateTitle(ArrayList<SimpleStamp> collection) {
        ...
        if (collection.isEmpty()) {
            sb.append(this.getString(R.string.yellow_stamp));
        } else {
            sb.append(this.getString(R.string.yellow_stamp)).append("  ").append(collection.size());
        }
